export default {
  ...
  catalog: {
    ...
    sameAsQuestion: 'Is this the same product? Choose one and the tariff code goes to it:',
    leaveUnapplied: 'Do not apply — leave it reported',
    resolvedByHand: 'chosen by hand',
